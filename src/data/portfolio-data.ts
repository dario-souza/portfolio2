...
export const portfolioData: PortfolioData = {
  ...
  cvUrl: '/dario-cv.pdf',
  about: 'Desenvolvedor Frontend apaixonado por criar experiências web modernas e responsivas. Com sólidos conhecimentos em React, Next.js e TypeScript, busco transformar ideias em soluções digitais elegantes e funcionais.',
  skills: [
  ...
  projects: [
    {
      ...
      description: 'Plataforma de e-commerce desenvolvida com Next.js, TypeScript e Stripe para pagamentos. Sistema completo de carrinho, autenticação e painel administrativo.',
    ...
    },
    {
      ...
      description: 'Aplicativo de gerenciamento de tarefas com drag-and-drop, categorias, prioridades e sincronização em tempo real.',
